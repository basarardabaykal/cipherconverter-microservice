...
func (s *server) EncryptOTP(ctx context.Context, req *symmetric.OTPRequest) (*common.CipherResponse, error) {
...
func (s *server) DecryptOTP(ctx context.Context, req *symmetric.OTPRequest) (*common.CipherResponse, error) {
	if len(req.GetText()) == 0 {
