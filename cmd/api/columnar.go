...
func (s *symServer) EncryptColumnar(ctx context.Context, req *symmetric.ColumnarRequest) (*common.CipherResponse, error) {
...
func (s *symServer) DecryptColumnar(ctx context.Context, req *symmetric.ColumnarRequest) (*common.CipherResponse, error) {
